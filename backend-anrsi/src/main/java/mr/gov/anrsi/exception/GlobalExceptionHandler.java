...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleMaxUploadSizeExceededException(org.springframework.web.multipart.MaxUploadSizeExceededException ex) {
        Map<String, String> error = new HashMap<>();
        error.put("error", "File size exceeds the maximum allowed size of 50MB. Please select a smaller file.");
        error.put("status", "PAYLOAD_TOO_LARGE");
        error.put("message", "The uploaded file is too large. Maximum file size is 50MB.");
